...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("AB_TEST", "MULTIVARIATE", "FEATURE_FLAG", name="experimenttype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "analysis_method",
            sa.Enum("FREQUENTIST", "BAYESIAN", name="analysismethod"),
            nullable=False,
        ),
        sa.Column("confidence_level", sa.Float(), nullable=False),
        sa.Column(
            "correction_method",
            sa.Enum("NONE", "FDR_BH", "HOLM", name="correctionmethod"),
            nullable=False,
        ),
